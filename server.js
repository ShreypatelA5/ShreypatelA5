...
var sequelize = new Sequelize('bumysonu', 'bumysonu', 'YvhL_DBhCmLdTL46pYmFSpeE9MPQZZTg', {
...
var tempVar = sequelize.define('Userss', {
    id:{
...
app.post('/insert-user', (req, res) => {
    const { name, email } = req.body;
        sequelize.sync().then(function () {
            ...
            // create a new "tempVar" and add it to the database
            tempVar.create({
                name: name,
                email: email
            }).then(function (tempVar) {
                res.redirect("/");
...
app.get('/', (req, res) => {
    sequelize.sync().then(function () {
        ...
        tempVar.findAll({ }).then(function(data){        
